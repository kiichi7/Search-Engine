...
//wrong!@@!@!@!@@@@@@@@@@@@@@@@@@@@@
//bug 1 :fixed by Wang Zhifu 2004-2-25; needn't substract the first prob.
//bug2 :+1.0 is deleted at 2004-3-25!!
...
//	dGivenNamePossibility+=log(m_roleTag.m_context.GetContextPossibility(0,2,3)+1.0)-log(m_roleTag.m_context.GetFrequency(0,2)+1.0);
	dGivenNamePossibility+=log(m_roleTag.m_context.GetContextPossibility(0,2,3));
...
//	dSingleNamePossibility+=log(m_roleTag.m_context.GetContextPossibility(0,1,4)+1.0)-log(m_roleTag.m_context.GetFrequency(0,1)+1.0);
	dSingleNamePossibility+=log(m_roleTag.m_context.GetContextPossibility(0,1,4));
